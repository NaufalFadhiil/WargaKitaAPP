                    ...
                    children: [
                      ...
                      GridView.count(
                        ...
                        children: [
                          _RecordCard(
                            title: "Buat Acara",
                            count: userData.counters['created_activity']?.toString() ?? '0',
                            gradientColors: const [Color(0xFF2E4A6F), Color(0xFF6A5ACD)],
                            icon: Icons.group_add_outlined,
                          ),
                          _RecordCard(
                            title: "Bantu Acara",
                            count: userData.counters['joined_activity']?.toString() ?? '0',
                            gradientColors: const [Color(0xFFFF7043), Color(0xFFFFA726)],
                            icon: Icons.group_outlined,
                          ),
                          _RecordCard(
                            title: "Buat Pinjaman",
                            count: userData.counters['created_help']?.toString() ?? '0',
                            gradientColors: const [Color(0xFF2E4A6F), Color(0xFF6A5ACD)],
                            icon: Icons.waving_hand_outlined,
                          ),
                          _RecordCard(
                            title: "Bantu Pinjaman",
                            count: userData.counters['helped_help']?.toString() ?? '0',
                            gradientColors: const [Color(0xFFFF7043), Color(0xFFFFA726)],
